...
import { profileUpdate, createProfile, getCountries, getStates, getLgas, saveProfile } from './../../redux/actions';
...
class EditProfile extends Component {
    ...
    pickImage() {
        ImagePicker.openPicker({
            ...
            this.setState({ profile: image.path, imageLink: 'https://urban945.com/user/avatar/1531057123.jpeg' });
            this.props.profileUpdate({ prop: 'photo', value: 'https://urban945.com/user/avatar/1531057123.jpeg' });
            console.log(image);
        });
    }
            ...
            <ScrollView style={{ backgroundColor: '#fff' }}>
                ...
                <View style={{ marginLeft: 15, marginRight: 15, marginTop: 20 }}>
                    <Content>
                        ...
                        <TouchableOpacity onPress={() => this.pickImage()} style={{ padding: 10, borderWidth: 0.5 }}>
                            <Text>{this.state.imageLink}</Text>
                        </TouchableOpacity>

                        <Image
                            source={{ uri: this.state.profile }}
                            style={{ height: 180, width: 250, marginTop: 10, flex: 1, justifyContent: 'center', marginBottom: 15 }}
                        />
...
export default connect(mapStateToProps, { createProfile, profileUpdate, getCountries, getStates, getLgas, saveProfile })(EditProfile);
