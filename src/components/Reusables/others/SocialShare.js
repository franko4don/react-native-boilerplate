...
import { toggleShareModalVisibility, setSharableContent } from './../../../redux/actions';
...
class SocialShare extends Component {
    ...
    render() {
        ...
        const { message, url, subject } = this.props;
...
const mapStateToProps = (state) => {
    ...
    const { shareVisibility, url, message, subject } = state.share;

    return { shareVisibility, url, message, subject }
};

export default connect(mapStateToProps, { toggleShareModalVisibility, setSharableContent })(SocialShare); 
